...
public class DeleteRecentViewProdAction extends AbstractController {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if("POST".equalsIgnoreCase(method)) {
			String recentseq = request.getParameter("recentseq");
			
			InterProductDAO_OHJ pdao = new ProductDAO_OHJ();
			boolean deleted = pdao.deleteRecentViewProd(recentseq);

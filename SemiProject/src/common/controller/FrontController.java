...
@WebServlet(
		...
		urlPatterns = { "*.go" }, 
		initParams = { 
				@WebInitParam(name = "propertyConfig", value = "C:/Users\\PINA\\git/SemiProject/SemiProject/WebContent\\WEB-INF/Command.properties", description = "*.go 에 대한 클래스의 매핑파일")
		})
public class FrontController extends HttpServlet {
	...
	*/
	...
	//	System.out.println("~~~ 확인용 key => " + key);
		...
		AbstractController action = (AbstractController)cmdMap.get(key); // 부모클래스인 AbstractController로 형변환

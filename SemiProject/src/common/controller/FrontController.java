...
@WebServlet(
		...
		urlPatterns = { "*.go" }, 
		initParams = { 
				@WebInitParam(name = "propertyConfig", value = "C:\\Users\\kimmk\\git\\SemiProject\\SemiProject\\WebContent\\WEB-INF\\Command.properties", description = "*.go에 대한 class의 맵핑파일이다.")
		})

...
public class MemberDAO_LCE implements InterMemberDAO_LCE {
	...
	// 회원가입을 해주는 메소드 생성
	@Override
	public int registerMember(MemberVO_LCE member) throws SQLException {
	...
	@Override
	public MemberVO_LCE selectOneMember(Map<String, String> paraMap) throws SQLException {
		MemberVO_LCE member = null;
	...
	// 회원의 개인 정보 변경하기
	@Override
	public int updateMember(MemberVO_LCE member) throws SQLException {

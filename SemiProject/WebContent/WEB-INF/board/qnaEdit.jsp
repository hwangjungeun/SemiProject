		...
		$("input#board_content").blur(function(){
		   ...
		   // *** 필수입력사항에 모두 입력이 되었는지 검사한다. *** //
			...
			if(checkboxCheckedLength == 0) {
				...
				frm.action = "<%=ctxPath%>/board/qnaEditEnd.go";
				frm.method = "get";
				frm.submit();
    ...
    <div id="contents">
		...
		<table class="tbl" border="1" >
         ...
         <td colspan="2" style="line-height: 90px;" class="text-center">
            <button type="button" id="btnUpdate" class="btn btn-dark btn-md mt-3" onClick="goEdit()">확인</button>
            <button type="button" id="btnUpdate" class="btn btn-dark btn-md mt-3 ml-5" onClick="self.close()">취소</button>
         </td>
      </tr>
		 </table>
		 </form>
